...
class TestInstructorDashboard(ModuleStoreTestCase, LoginEnrollmentTestCase, XssTestMixin):
    ...
    @ddt.unpack
    def test_discussion_tab_staff(self, access_role, is_pages_and_resources_enabled,
                                  is_legacy_discussion_setting_enabled, is_discussion_tab_available):
        """
        Verify that the Discussion is visible/hidden with flags enabled/disabled for course for staff role.
        """
    ...
    @ddt.unpack
    def test_discussion_tab_instructor(self, access_role, is_pages_and_resources_enabled,
                                       is_legacy_discussion_setting_enabled, is_discussion_tab_available):
        """
        Verify that the Discussion is visible/hidden with flags enabled/disabled for course for instructor role.
        """
        discussion_section = '<li class="nav-item"><button type="button" class="btn-link discussions_management" ' \
                             'data-section="discussions_management">Discussions</button></li>'
    ...
    @ddt.data(
        ('global_staff', False, False, True),
        ('global_staff', True, False, False),
        ('global_staff', True, True, True),
    )
    @ddt.unpack
    def test_discussion_tab_global(self, access_role, is_pages_and_resources_enabled,
                                   is_legacy_discussion_setting_enabled, is_discussion_tab_available):
        """
        Verify that the Discussion is visible/hidden with flags enabled/disabled for course for global role.
        """
        discussion_section = '<li class="nav-item"><button type="button" class="btn-link discussions_management" ' \
                             'data-section="discussions_management">Discussions</button></li>'
