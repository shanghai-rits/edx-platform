...
if FEATURES.get('ENABLE_THIRD_PARTY_AUTH'):
    tmp_backends = ENV_TOKENS.get('THIRD_PARTY_AUTH_BACKENDS', [
        ...
        'common.djangoapps.third_party_auth.wechat.CustomWeixinOAuth2',
        'common.djangoapps.third_party_auth.qq.CustomQQOAuth2',
        'common.djangoapps.third_party_auth.weibo.CustomWeiboOAuth2',
    ])
