    ...
    define([
        ...
        return FormView.extend({
            ...
            events: {
                ...
                'blur .text-phone > input': 'isPhone',
                'click .phoneCode': 'getSMSCode'
            },
            formType: 'phone_login',
            requiredStr: '',
            optionalStr: '',
                ...
                if(validPhone){
                    ...
                    var timer = setInterval(function () {
                        if (time <= 0) {
                            ...
                            $("#phone_login-sms_code").removeClass("codeSent");
                            $(el).css("background", "#57068c");
                        } else {
                            $(el).addClass("inactive");
                            $("#phone_login-sms_code").addClass("codeSent");
