                    ...
                    fields: [
                        {
                            view: new AccountSettingsFieldViews.ReadonlyFieldView({
                                ...
                                helpMessage: StringUtils.interpolate(
                                    gettext('The name that identifies you throughout {platform_name}. You cannot change your UID.'),  // eslint-disable-line max-len
                                    {platform_name: platformName}
                                )
                            })
                        },
                        ...
                        emailFieldView,
                        {
                            view: new AccountSettingsFieldViews.TextFieldView({
                                ...
                                valueAttribute: 'user_displayname',
                                helpMessage: StringUtils.interpolate(
                                    gettext('The name that is used for display in {platform_name}, including any characters.'),  // eslint-disable-line max-len
                                    {platform_name: platformName}
                                ),
                                persistChanges: true
                            })
