(function(define) {
    ...
    define([
        ...
        'js/student_account/models/PhoneLoginModel',
        'js/student_account/models/PasswordResetModel',
        'js/student_account/models/RegisterModel',
        'js/student_account/models/PhoneRegisterModel',
        'js/student_account/models/AccountRecoveryModel',
        'js/student_account/models/GetSMSCodeModel',
        'js/student_account/views/LoginView',
        'js/student_account/views/PhoneLoginView',
        'js/student_account/views/PasswordResetView',
        'js/student_account/views/RegisterView',
        'js/student_account/views/PhoneRegisterView',
        ...
        function($, utility, _, _s, Backbone, LoginModel, PhoneLoginModel, PasswordResetModel, RegisterModel, PhoneRegisterModel, AccountRecoveryModel, GetSMSCodeModel,
                 LoginView, PhoneLoginView, PasswordResetView, RegisterView, PhoneRegisterView, InstitutionLoginView, HintedLoginView, HtmlUtils,
            ...
            // The form currently loaded
                 ...
                 */
                    ...
                    this.formDescriptions = {
                        ...
                        phone_login: options.phone_login_form_desc,
                        register: options.registration_form_desc,
                        phone_register: options.phone_registration_form_desc,
                ...
                // The login view listens for 'sync' events from the reset model
                    ...
                    this.smsModel = new GetSMSCodeModel({}, {
                        method: 'POST',
                        url: '/auth/phone'
                    });
                ...
                load: {
                    ...
                    phone_login: function(data) {
                        var model = new PhoneLoginModel({}, {
                            method: data.method,
                            url: data.submit_url
                        });
                        var isTpaSaml = this.thirdPartyAuth && this.thirdPartyAuth.finishAuthUrl ?
                        ...
                        this.subview.phoneLogin = new PhoneLoginView({
                            fields: data.fields,
                            model: model,
                            resetModel: this.resetModel,
                            accountRecoveryModel: this.accountRecoveryModel,
                    ...
                    // Listen for 'password-help' event to toggle sub-views
                        this.listenTo(this.subview.phoneLogin, 'password-help', this.resetPassword);

                    // Listen for 'auth-complete' event so we can enroll/redirect the user appropriately.
                        if (!isTpaSaml) {
                            this.listenTo(this.subview.phoneLogin, 'auth-complete', this.loginComplete);
                        } else {
                            this.listenTo(this.subview.phoneLogin, 'auth-complete', this.authComplete);
                        }
                    },
                    ...
                    phone_register: function(data) {
                        var model = new PhoneRegisterModel({}, {
                            method: data.method,
                            url: data.submit_url,
                            nextUrl: this.nextUrl
                        });

                        this.subview.phoneRegister = new PhoneRegisterView({
                            fields: data.fields,
                            model: model,
                            thirdPartyAuth: this.thirdPartyAuth,
                            platformName: this.platformName,
                    ...
                    // Listen for 'auth-complete' event so we can enroll/redirect the user appropriately.
                        this.listenTo(this.subview.phoneRegister, 'auth-complete', this.authComplete);
                    },
