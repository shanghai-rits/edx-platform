(function(define) {
    define([
        ...
        'js/discovery/collections/user_defined_facets'
    ], function (_, Backbone, CourseDiscovery, Filters, UserDefinedFacets) {
        'use strict';
        ...
        return Backbone.Model.extend({
            ...
            initialize: function() {
                this.ufacets = new UserDefinedFacets();
        ...
        // private
            ...
            sendQuery: function (data) {
                ...
                this.discovery.set('terms', this.terms);
                var self = this;
                this.ufacets.fetch({success: function () {
                self.discovery.set('facet_records', self.ufacets.models);
                self.jqhxr = self.discovery.fetch({
                    type: 'POST',
                    data: data
                });
                return self.jqhxr;
