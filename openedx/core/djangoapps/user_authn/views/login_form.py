...
from openedx.core.djangoapps.user_authn.views.phone_login_form import PhoneLoginFormFactory
from openedx.core.djangoapps.user_authn.views.phone_registration_form import PhoneRegistrationFormFactory
...
def login_and_registration_form(request, initial_mode="login"):
    ...
    context = {
        'data': {
            ...
            'phone_login_form_desc': json.loads(form_descriptions['phone_login']),
            'phone_registration_form_desc': json.loads(form_descriptions['phone_registration']),
...
def _get_form_descriptions(request):
    ...
    return {
        ...
        'phone_login': PhoneLoginFormFactory().get_login_session_form(request).to_json(),
        'phone_registration': PhoneRegistrationFormFactory().get_registration_form(request).to_json(),
    }
