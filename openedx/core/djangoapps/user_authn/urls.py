...
urlpatterns += [
    ...
    url(r'^phone_login$', login_form.login_and_registration_form,
        {'initial_mode': 'phone_login'}, name='phone_signin_user'),
    url(r'^register$', login_form.login_and_registration_form,
        {'initial_mode': 'register'}, name='register_user'),
    url(r'^phone_register$', login_form.login_and_registration_form,
        {'initial_mode': 'phone_register'}, name='phone_register_user'),
    url(r'^password_assistance', login_form.login_and_registration_form,
        {'initial_mode': 'reset'}, name='password_assistance'),
    url(r'^reset_password$', login.reset_password, name='reset_password'),
]
