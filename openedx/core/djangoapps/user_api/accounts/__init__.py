...
# The minimum and maximum length for the user_displayname account field
USER_DISPLAYNAME_MIN_LENGTH = 1
USER_DISPLAYNAME_MAX_LENGTH = 255

# The length for the phone account field
PHONE_LENGTH = 11

# The length for the sms_code account field
SMS_CODE_LENGTH = 6
...
USER_DISPLAYNAME_INVALID_CHARS_UNICODE = _(
    "Nicknames can only contain letters, numerals, and @/./+/-/_ characters."
)

PHONE_INVALID_CHARS_UNICODE = _(
    "Please enter a valid phone number."
)

SMS_CODE_INVALID_CHARS_UNICODE = _(
    "SMS Code can only contain numerals."
)
...
USER_DISPLAYNAME_CONFLICT_MSG = _(
    "It looks like {Nickname} belongs to an existing account. "
    "Try again with a different nickname."
)

PASSWORD_MISMATCH_ERROR_MSG = _("The passwords you entered do not match. Please try again.")
...
USER_DISPLAYNAME_BAD_LENGTH_MSG = format_lazy(
    _("Nickname must be between {min} and {max} characters long."),
    min=USER_DISPLAYNAME_MIN_LENGTH,
    max=USER_DISPLAYNAME_MAX_LENGTH,
)
PHONE_BAD_LENGTH_MSG = format_lazy(
    _("Phone number must be {length} characters long."),
    length=PHONE_LENGTH,
)
SMS_CODE_BAD_LENGTH_MSG = format_lazy(
    _("SMS Code must be {length} characters long."),
...
USER_DISPLAYNAME_BAD_TYPE_MSG = "User displayname must be a string."
PHONE_BAD_TYPE_MSG = "Phone must be a string."
SMS_CODE_BAD_TYPE_MSG = "SMS Code must be a string."
