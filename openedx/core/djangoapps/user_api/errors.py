...
class AccountUserDisplaynameInvalid(AccountRequestError):
    """The requested displayname is not in a valid format. """
    pass  # lint-amnesty, pylint: disable=unnecessary-pass
...
class AccountSmsCodeInvalid(AccountRequestError):
    """The requested sms code is not in a valid format. """
    pass  # lint-amnesty, pylint: disable=unnecessary-pass
