...
#     urlpatterns += [
#         url(r'^user_api/v1/account/login_session/$', user_api_views.LoginSessionView.as_view(),
#             name="user_api_login_session_legacy"),
#         url(r'^user_api/v1/account/registration/$', user_api_views.RegistrationView.as_view(),
#             name="user_api_registration_legacy"),
#         url(r'^user_api/v1/account/password_reset/$', user_api_views.PasswordResetView.as_view(),
