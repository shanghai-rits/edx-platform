        ...
        for attribute in ABOUT_ATTRIBUTES:
            ...
            if attribute == 'overview' and course_details.course_about_html_editor is False:
                try:
                    ...
                    course_details.overview = soup.body.prettify()
                    ...
                    if about is None:
                        ...
                        for p in about.find_all('p'):
                            course_details.overviews['about'] += p.get_text().strip()
                    ...
                    if prerequisites is None:
                        ...
                        for p in prerequisites.find_all('p'):
                            course_details.overviews['prerequisites'] += p.get_text().strip()
                            if p.next_sibling is not None:
                                course_details.overviews['prerequisites'] += '\n'
