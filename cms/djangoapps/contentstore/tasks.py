...
@shared_task
@set_code_owner_attribute
def rerun_course(source_course_key_string, destination_course_key_string, user_id, eng_display_name, chinese_display_name, fields=None):
    """
    ...
    try:
        ...
        CourseOverviewExpansion.objects.create(course_overview=destination_course_key_string,
