...
def reverse_facet_url(handler_name, facet_key, kwargs=None):
    """
    Creates the URL for handlers that use facet_keys as URL parameters.
    """
    return reverse_url(handler_name, 'facet_key_string', facet_key, kwargs)
