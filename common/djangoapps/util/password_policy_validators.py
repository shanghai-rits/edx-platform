    ...
    def validate(self, password, user=None):
        if len(password) < self.min_length:
            raise ValidationError(
                ngettext(
                    'This password is too short. It must contain no less than %(min_length)d character.',
                    'This password is too short. It must contain no less than %(min_length)d characters.',
                    self.min_length
                ),
