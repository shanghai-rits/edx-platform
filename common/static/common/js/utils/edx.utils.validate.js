                ...
                var _fn = {
                    validate: {
                        ...
                        msg: {
                            ...
                            confirmPassword: gettext("The password and its confirm are not the same.")
                        },
                        ...
                        field: function(el) {
                            ...
                            if (_fn.validate.isRequired($el)) {
                                if (isBlank) {
                                    ...
                                    confirmPassword = _fn.validate.isConfirmedPassword($el);
                                }
                            } else if (!isBlank) {
                                min = _fn.validate.str.minlength($el);
                                max = _fn.validate.str.maxlength($el);
                            ...
                            response.isValid = required && min && max && email && confirmPassword;
                        ...
                        isConfirmedPassword: function($el){
                            var confirmedPasswordVar = true;
                            if ($el.attr('name')=='confirm_password'){
                                confirmedPasswordVar = $el.val()==$('#register-password').val();
                            }
                            return confirmedPasswordVar;
                        },
